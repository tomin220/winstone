    ...
    <footer className="footer">
      ...
      <div className="container footer-content">
        ...
        <div className="footer-brand">
          <div className="footer-logo">
            <div className="footer-logo-image-wrapper">
              <img src="/images/winstonelogo.jpg" alt="Winstone Logo" className="footer-logo-img" />
            </div>
          ...
          <p className="footer-tagline">
            Building legacy and impacting tomorrow through innovative premium real estate development across UAE &amp; India.
          </p>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li><a href="/#companies">Group Companies</a></li>
        ...
        {/* Contact */}
        <div className="footer-col">
          <h4 className="footer-col-title">Dubai HQ</h4>
          <ul className="footer-contact-list">
            <li>
              ...
              <span>Al Wasl Building, Sheikh Zayed Road, Near Dubai Mall Metro, Dubai UAE</span>
            </li>
            <li>
              ...
              <a href="tel:+971504158382">+971 504 158 382</a>
            </li>
            <li>
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p>© 2024 Winstone Group. All rights reserved.</p>
          <p className="footer-tagline-bottom">Building Tomorrow's Legacy Through Excellence and Innovation.</p>
        </div>
      </div>
    </footer>
  );
